          ...
          <div className="flex items-center gap-4">
            {isMounted && isAuthenticated ? (
              <>
                <Link 
                  href="/dashboard"
                  className="px-4 py-2 border border-cyan-500/30 hover:border-cyan-500 text-cyan-400/70 hover:text-cyan-400 bg-cyan-500/5 hover:bg-cyan-500/10 rounded-full font-bold uppercase tracking-widest text-[10px] transition-all duration-300"
                >
                  Private Ledger
                </Link>
                <button 
            ...
            >
              <span className="uppercase tracking-widest text-[10px]">Cart</span>
